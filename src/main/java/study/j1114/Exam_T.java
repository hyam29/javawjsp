...
public class Exam_T extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		// 화폐단위 콤마(,) 사용 위한 객체 생성 ("###,###.##")는 3자리마다 콤마를 찍고, 소수 2자리까지만 출력한다는 의미
		...
		for(int i=0; i<products.length; i++) {
			...
			out.print("<td>" + decFormat.format(price) + "</td>"); // .format()에 숫자변수 넣으면 , 찍음
