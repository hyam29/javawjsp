...
<div class="container">
	...
	<form name="myform" method="post" action="${pageContext.request.contextPath}/study/el_jstl/El1">
		...
		<div>
			첫번째 수 : <input type="text" name="su1" value="100" class="form-control" />
		</div>
		<div>
			두번째 수 : <input type="text" name="su2" value="200" class="form-control" />
		</div>
		<div>
			<input type="submit" value="전송" class="btn btn-primary form-control" />
		</div>
	</form>
</div>
<p><br/></p>
