...
<div class="container">
	...
	<div class="container">
	  ...
	  <input type="button" class="btn w3-black w3-hover-teal" value="Input Button">
	  <button class="btn w3-black w3-hover-green">Button Button</button>
	  <a href="#" class="btn w3-black w3-hover-light-green">Link Button</a>
	  <hr/><br/>
	  <div style="width:600px; heigth:200px;" class="w3-lime">
	  	이곳은 내용 영역 입니다.
	  </div>
	</div>
</div>	
