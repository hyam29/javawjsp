...
<div class="container">
	...
	<hr/>
	<div class="row">
		<div class="col"><a href="t1_CookiesSave.jsp" class="btn btn-primary form-control">쿠키 저장</a></div>
		...
		<div class="col"><a href="t1_CookiesDeletePwd.jsp" class="btn btn-warning form-control">특정 쿠키(비밀번호) 삭제</a></div>
	</div>
</div>
<p><br/></p>
</body>
