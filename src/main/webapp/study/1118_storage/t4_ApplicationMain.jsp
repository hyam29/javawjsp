...
<div class="container">
	...
	<form name="myform" method="post" action="t4_ApplicationSave.jsp">
		...
		<div class="row mb-3">
			<div class="col"><input type="submit" value="Application저장(서버기동 후 처음 1회만 수행할 것!!!)" class="btn btn-primary form-control" /></div>
			<div class="col"><a href="t4_ApplicationCheck.jsp" class="btn btn-success form-control">Application 확인</a></div>
		</div>
		<div class="row">
			<div class="col"><a href="t4_ApplicationDelNick.jsp" class="btn btn-warning form-control">Application(닉네임) 삭제</a></div>
		</div>
	</form>
</div>
<p><br/></p>
