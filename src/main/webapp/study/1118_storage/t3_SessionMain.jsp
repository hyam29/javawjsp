...
<div class="container">
	...
	<form name="myform" method="post" action="t3_SessionSave.jsp">
		...
		<div class="row mb-3">
			<div class="col"><input type="submit" value="세션저장" class="btn btn-primary form-control" /></div>
		...
		<div class="row mb-3">
			<div class="col"><a href="t3_SessionGroup.jsp" class="btn btn-info form-control">세션그룹 확인</a></div>
		</div>
	</form>
</div>
<p><br/></p>
