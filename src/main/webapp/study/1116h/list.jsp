...
<% 
	...
	String pTot = vo.getpTot(); 

%>
<div class="container">
	<h2>상품 조회 '-'</h2>
	<div>등록하신 상품을 조회하실 수 있습니다.</div>
	<hr/>
	<table class="table">
		<tr>
			<td>
...
<%
	/* InputVO vo2 = new InputVO(name,strCode,strProduct,strSu,strPrice,pTot); */
 
 	request.setAttribute("vo", vo);
 
	String viewPage = "/study/1116h/main.jsp?vo=";
