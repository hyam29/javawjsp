...
<div class="container text-center">
  ...
  <hr/>
<%if(mid.equals("admin")) { %>
  <div><a href="${pageContext.request.contextPath}/study/storage2/T5_LoginCountInit" class="btn btn-success form-control m-1">전체 방문카운트 초기화</a></div>
<%} %>
  <div><a href="${pageContext.request.contextPath}/study/storage2/T5_LogOut" class="btn btn-success form-control m-1">로그아웃</a></div>
</div>
<p><br/></p>
</body>
</html>