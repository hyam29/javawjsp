...
<div class="container">
  <div class="text-center">
  	<button type="button" onclick="location.href='${ctp}/schedule.sc?yy=${yy-1}&mm=${mm}';" class="btn btn-outline-secondary btn-sm" title="이전년도">◁◁</button> 
  	<button type="button" onclick="location.href='${ctp}/schedule.sc?yy=${yy}&mm=${mm-1}';" class="btn btn-outline-secondary btn-sm" title="이전월">◀</button> 
    <font size="5">${yy}년 ${mm+1}월</font>
  	<button type="button" onclick="location.href='${ctp}/schedule.sc?yy=${yy}&mm=${mm+1}';" class="btn btn-outline-secondary btn-sm" title="다음월">▶</button> 
  	<button type="button" onclick="location.href='${ctp}/schedule.sc?yy=${yy+1}&mm=${mm}';" class="btn btn-outline-secondary btn-sm" title="다음년도">▷▷</button> 
  	<button type="button" onclick="location.href='${ctp}/schedule.sc';" class="btn btn-outline-secondary btn-sm" title="오늘날짜"><i class="fa fa-home"></i></button> 
  </div>
  <br/>
  <div class="text-center">
